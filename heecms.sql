...
#
# Structure for table "heecms_grabs"
#

DROP TABLE IF EXISTS `heecms_grabs`;
CREATE TABLE `heecms_grabs` (
  `grabs_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `desc` varchar(255) DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL COMMENT '网站网址',
  `users_id` varchar(255) DEFAULT NULL,
  `category_id` int(11) DEFAULT '0' COMMENT '需要插入的category',
  `epage` int(11) DEFAULT '1' COMMENT '每次采集的详细页数量',
  `urls` text COMMENT '要采集的网址',
  `startpage` int(11) DEFAULT NULL COMMENT '开始的页码',
  `endpage` int(11) DEFAULT NULL COMMENT '结束的页码',
  `linkstart` varchar(255) DEFAULT NULL,
  `linkend` varchar(255) DEFAULT NULL,
  `baseurl` varchar(255) DEFAULT NULL,
  `filterlinks` varchar(3000) DEFAULT NULL COMMENT '要过滤的网址',
  `titlestart` varchar(1000) DEFAULT NULL,
  `titleend` varchar(1000) DEFAULT NULL,
  `authorstart` varchar(1000) DEFAULT NULL,
  `authorend` varchar(1000) DEFAULT NULL,
  `timestart` varchar(1000) DEFAULT NULL,
  `timeend` varchar(1000) DEFAULT NULL,
  `contentstart` varchar(1000) DEFAULT NULL,
  `contentend` varchar(1000) DEFAULT NULL,
  `filterhtml` varchar(2000) DEFAULT NULL COMMENT '过滤内容html tags',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  `delete_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`grabs_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='抓取数据方案';

#
# Data for table "heecms_grabs"
#

/*!40000 ALTER TABLE `heecms_grabs` DISABLE KEYS */;
INSERT INTO `heecms_grabs` VALUES (2,'PHP教程','','#','1',2,5,'https://www.west.cn/docs/network/php/page/[p]',2,10,'<div class=\"content\">','<aside class=\"sidebar\">','#','https://www.west.cn/docs/network/php\r\nhttps://www.west.cn/docs/network','<title>','-西部数码知识库</title>','','','<div class=\"article-meta\">\r\n\t\t\t\t<span class=\"item\">','<div class=\"article-meta\">\r\n\t\t\t\t<span class=\"item\">','<article class=\"article-content\">','</article>','p span pre img',1610804142,1610833969,NULL);
/*!40000 ALTER TABLE `heecms_grabs` ENABLE KEYS */;

#
# Structure for table "heecms_grabs_detail"
#

DROP TABLE IF EXISTS `heecms_grabs_detail`;
CREATE TABLE `heecms_grabs_detail` (
  `grabs_detail_id` int(11) NOT NULL AUTO_INCREMENT,
  `grabs_id` int(11) DEFAULT NULL,
  `url` varchar(3000) DEFAULT NULL,
  `title` varchar(2000) DEFAULT NULL,
  `author` varchar(1000) DEFAULT NULL,
  `time` varchar(1000) DEFAULT NULL,
  `content` longtext,
  `firstpic` varchar(3000) DEFAULT NULL,
  `create_time` int(11) DEFAULT NULL,
  `users_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`grabs_detail_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

#
# Data for table "heecms_grabs_detail"
#

/*!40000 ALTER TABLE `heecms_grabs_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `heecms_grabs_detail` ENABLE KEYS */;

#
# Structure for table "heecms_grabs_list"
#

DROP TABLE IF EXISTS `heecms_grabs_list`;
CREATE TABLE `heecms_grabs_list` (
  `grabs_list_id` int(11) NOT NULL AUTO_INCREMENT,
  `grabs_id` int(11) DEFAULT NULL,
  `url` varchar(3000) DEFAULT NULL,
  `create_time` int(11) DEFAULT NULL COMMENT '采集时间',
  `users_id` int(11) DEFAULT NULL COMMENT '采集人',
  `isread` int(11) DEFAULT '0',
  PRIMARY KEY (`grabs_list_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='抓取列表页网址';

#
# Data for table "heecms_grabs_list"
#

/*!40000 ALTER TABLE `heecms_grabs_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `heecms_grabs_list` ENABLE KEYS */;

#
# Structure for table "heecms_grabs_log"
#

DROP TABLE IF EXISTS `heecms_grabs_log`;
CREATE TABLE `heecms_grabs_log` (
  `grabs_log_id` int(11) NOT NULL AUTO_INCREMENT,
  `grabs_id` int(11) DEFAULT NULL,
  `users_id` int(11) DEFAULT NULL,
  `log` varchar(2000) DEFAULT NULL,
  `create_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`grabs_log_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='采集日志';

#
# Data for table "heecms_grabs_log"
#

/*!40000 ALTER TABLE `heecms_grabs_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `heecms_grabs_log` ENABLE KEYS */;
