	...
	$.fn.Huitags = function(options) {
		...
		this.each(function(){
			...
			input.on("change",function(){
				...
				var v = v2+','+v1;
				if(v!=''){
					var str='<i class="Huitags-icon Heeiconfont">&#xe64b;</i>';
...
!function($) {
	...
	$.Huitotop = function(bottom){
		...
		var str ='<a href="javascript:void(0)" class="tools-right toTop Heeiconfont" title="返回顶部" alt="返回顶部" style="display:none;bottom:'+bottom+'px">&#xe684;</a>';
