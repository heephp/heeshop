                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                   aria-controls="home" aria-selected="true">基本</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="adv-tab" data-toggle="tab" href="#adv" role="tab"
                                   aria-controls="adv" aria-selected="false">高级</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active mt-2" id="home" role="tabpanel"
                                ...
                                <div class="tab-pane fade  show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <div class="col-md-10">
                                            <?= conf('website_url') ?>/<input class="" name="route" type="text"
                                                                              placeholder="" value="<?= $m['route'] ?>">为空表示使用默认网址
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label" for="inlineinput">页面标题</label>
                                        <input class="form-control input-full" name="title" type="text" placeholder=""
                                               value="<?= $m['title'] ?>">
                                    </div>

                                    <div class="form-group">
                                        <label class="col-form-label" for="inlineinput">页面关键词</label>
                                        <input class="form-control input-full" name="keyword" type="text" placeholder=""
                                               value="<?= $m['keyword'] ?>">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="adv" role="tabpanel" aria-labelledby="adv-tab">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <input class="form-control col-md-2 input-full" id="template" name="template"
                                               type="text" placeholder="" value="<?= $m['template'] ?? 'list' ?>">
                                        <input type="button" id="select_template" class=" col-md-1 btn btn-primary"
                                               value="选择模板">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" id="sprice"
                                           onclick="$('.price').css('display',$('.price').css('display')=='none'?'block':'none');$('.price input').val('')"><label
                                            for="sprice">需要购买</label><span class="text-info">如果不需要购买，则不需要填写</span>
                                </div>
                                <div class="form-group price" style="display: none">
                                    <label for="link">价格</label>
                                    <input type="number" class="form-control col-3" name="price" placeholder="价格"
                                           value="<?= $m['price'] ?? '0' ?>">
                                </div>
