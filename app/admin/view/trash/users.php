                    ...
                    <table class="table">
                        ...
                        <?foreach($list as $m){?>
                            <tr>
                                ...
                                <td><?=$m['create_time']?></td>
                                <td>
                                    <a href="<?=url('users_re/'.$m['users_id'])?>" class="btn btn-warning btn-primary btn-sm">还原</a>

                                    <a href="#" class="btn btn-danger btn-sm delete" url="<?=url('users_del/'.$m['users_id'])?>">删除</a>
