            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?=url('save')?>" method="post">
                        <input type="hidden" name="link_id" value="<?=$m['link_id']?>">
                        <input type="hidden" name="link_group_id" value="<?=$link_group_id??$m['link_group_id']?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_id">
                                        ...
                                        <?foreach ($plist as $p){?>
                                            <option value="<?=$p['link_id']?>" <?=$p['link_id']==$m['parent_id']||$pid==$p['link_id']?'selected':''?>><?=$p['title']?></option>
                                        <?}?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="icon" id="icon" type="text" value="<?=$m['icon']?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="url" placeholder="链接" value="<?=$m['url']?>">
                                </div>
                                <div class="form-group">
                                    <label for="link">窗口</label>
                                    <select class="form-control" name="target">
                                        <option value="_blank" <?=$m['target']=='_blank'?'select':''?>>新窗口</option>
                                        <option value="_self"" <?=$m['target']=='_self'?'select':''?>>当前窗口</option>
                                    </select>
                                </div>
                                <div class="form-group">
